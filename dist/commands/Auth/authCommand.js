  ...
  program
    ...
    .action((cmd) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        let configJSON = jsonfile_1.readFileSync(
          `${cmd["appName"]}/config.json`
        );
        ...
        jsonfile_1.writeFileSync(`${cmd["appName"]}/auth.json`, authJSON, {
          spaces: 4,
          EOL: "\r\n",
        });
        if (!configJSON["appID"])
          configJSON["appID"] = cmd["appID"] || answer["appID"];
        jsonfile_1.writeFileSync(`${cmd["appName"]}/config.json`, configJSON, {
          spaces: 4,
          EOL: "\r\n",
        });
        ...
        console.log(
          chalk_1.default.greenBright(
            `     kintone-cli dev --app-name ${cmd["appName"]}`
          )
        );
        console.log("");
        ...
        console.log(
          chalk_1.default.greenBright(
            `     kintone-cli deploy --app-name ${cmd["appName"]}`
          )
        );
        console.log("");
      })
